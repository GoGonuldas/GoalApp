...
/**
 * Örnek arşiv hedefleri sağlayan sınıf.
 * Production'da kullanılmamalı, sadece geliştirme/test amaçlı.
 */
@Singleton
class SampleGoalsProvider @Inject constructor() {

    /**
     * Son 14 güne ait örnek arşiv hedefleri oluşturur
     */
    fun buildArchiveSampleGoals(): List<GoalEntity> {
        ...
        fun goal(
            ...
            return GoalEntity(
                title = title,
                description = "Örnek arşiv verisi",
                targetValue = target,
